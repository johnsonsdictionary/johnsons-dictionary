 ...
 */
public class JohnsonsDictionaryWordDefinition {
    private JohnsonsDictionaryWordDefinitionId wordDefinitionId;
    private Optional<Boolean> stressOnLastSyllable;
    private List<String> components;

    public JohnsonsDictionaryWordDefinition(JohnsonsDictionaryWordDefinitionId wordDefinitionId, boolean stressOnLastSyllable, List<String> components) {
        this.wordDefinitionId = wordDefinitionId;
        this.stressOnLastSyllable = Optional.of(stressOnLastSyllable);
        this.components = components;
    }

    public JohnsonsDictionaryWordDefinition(JohnsonsDictionaryWordDefinitionId wordDefinitionId, boolean stressOnLastSyllable) {
        this.wordDefinitionId = wordDefinitionId;
        this.stressOnLastSyllable = Optional.of(stressOnLastSyllable);
        this.components = Arrays.asList(wordDefinitionId.getWord());
    }

    public JohnsonsDictionaryWordDefinition(JohnsonsDictionaryWordDefinitionId wordDefinitionId) {
        this.wordDefinitionId = wordDefinitionId;
    ...
    public JohnsonsDictionaryWordDefinitionId getWordDefinitionId() {
