...
public class ToDressVerbConjugationDemo {
    ...
    public static void main(String[] args) {
        ...
        VerbConjugation iRegularVerbConjugation = VerbConjugators.IRREGULAR_VERB_CONJUGATOR.getConjugatedVerb(EnglishWordsEnGB.ALL_IRREGULAR_VERBS.get(WordDefinitionId.create("dress", 1)));
