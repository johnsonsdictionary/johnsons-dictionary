...
/**
 * Statically defined variables to hold loaded collections of obsolete words
 *
 * @author Michael Lavelle
 */
public class ObsoleteWords {


    private final static String OBSOLETE_WORDS = "/obsolete-words/obsolete_words.csv";

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_OBSOLETE_WORDS = new WordDefinitionCSVReader(false, OBSOLETE_WORDS).load();

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_WORDS = new TreeMap<>();

    static {
        ALL_WORDS.putAll(ALL_OBSOLETE_WORDS);
    }
