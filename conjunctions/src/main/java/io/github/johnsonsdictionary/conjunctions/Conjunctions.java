...
/**
 * Statically defined variables to hold loaded collections of conjunctions
 *
...
public class Conjunctions {
    ...
    private final static String CONJUNCTIONS_FILE_PATH = "/conjunctions/conjunctions.csv";

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_CONJUNCTIONS = new WordDefinitionCSVReader(false, CONJUNCTIONS_FILE_PATH).load();

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_WORDS = new TreeMap<>();

    static {
        ALL_WORDS.putAll(ALL_CONJUNCTIONS);
    }
