...
/**
 * Statically defined variables to hold loaded collections of interjections
 *
...
public class Interjections {
    ...
    private final static String INTERJECTIONS_FILE_PATH = "/interjections/interjections.csv";

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_INTERJECTIONS = new WordDefinitionCSVReader(false, INTERJECTIONS_FILE_PATH).load();

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_WORDS = new TreeMap<>();

    static {
        ALL_WORDS.putAll(ALL_INTERJECTIONS);
    }
