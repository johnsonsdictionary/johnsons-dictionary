...
public class Pronouns {
    ...
    private final static String PRONOUNS_FILE_PATH = "/pronouns/pronouns.csv";

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_PRONOUNS = new WordDefinitionCSVReader(false, PRONOUNS_FILE_PATH).load();

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_WORDS = new TreeMap<>();

    static {
        ALL_WORDS.putAll(ALL_PRONOUNS);
    }
