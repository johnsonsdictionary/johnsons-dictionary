...
/**
 * Statically defined variables to hold loaded collections of articles
 *
...
public class Articles {
    ...
    private final static String ARTICLES_FILE_PATH = "/articles/articles.csv";

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_ARTICLES = new WordDefinitionCSVReader(false, ARTICLES_FILE_PATH).load();

    public final static SortedMap<WordDefinitionId, WordDefinition> ALL_WORDS = new TreeMap<>();

    static {
        ALL_WORDS.putAll(ALL_ARTICLES);
    }
